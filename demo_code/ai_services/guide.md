...
<!-- PageFooter="Practical guide to building agents" -->
<!-- PageNumber="2" -->
<!-- PageBreak -->
...
<!-- PageFooter="A practical guide to building agents" -->
<!-- PageNumber="3" -->
<!-- PageBreak -->
...
<!-- PageHeader="For example, here's how you could implement this pattern in the Agents SDK:" -->
